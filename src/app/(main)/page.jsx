        ...
        <div className="container mx-auto px-6 py-20 flex flex-col lg:flex-row items-center gap-x-12">
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            ...
            <p className="text-lg mb-6">
              Bergabunglah dengan pelatihan medis dan kesehatan terpercaya untuk
              dokter dan tenaga medis profesional, diselenggarakan oleh FTC
              bersama mitra berpengalaman.
            </p>
            <Link href="/pelatihan">
          ...
          <div className="hidden lg:block lg:w-1/2">
            <img
              ...
              className="rounded-lg mx-auto shadow-md p-12"
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Didukung oleh para ahli dan praktisi medis terkemuka di
                bidangnya.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Dapatkan sertifikat yang diakui dan meningkatkan nilai
                profesional Anda.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Bekerja sama dengan rumah sakit dan institusi kesehatan
                terpercaya.
              </p>
            </div>
          </div>
